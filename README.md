...
1. **Tải bản đóng gói phát hành sẵn:**  
   👉 **[📥 Tải về ITSupportToolSuite-v1.2.3.exe](https://github.com/HoangGia73/HelpdeskApp/releases/download/v1.2.3/ITSupportToolSuite-v1.2.3.exe)** (Bản Portable)  
...
3. Kiểm tra mã SHA-256 để đảm bảo tính toàn vẹn:
   ...
   ```
   *(Đối chiếu kết quả với file [`dist/SHA256SUMS-v1.2.3.txt`](https://github.com/HoangGia73/HelpdeskApp/releases/download/v1.2.3/SHA256SUMS-v1.2.3.txt))*
